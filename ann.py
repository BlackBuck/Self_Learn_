...
class ann:
    ...
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate) -> None:
        ...
        self.input_bias = numpy.random.normal(0.0, pow(self.hidden_nodes, -0.50), (self.hidden_nodes, 1))
        self.hidden_bias = numpy.random.normal(0.0, pow(self.output_nodes, -0.50), (self.output_nodes, 1))
    ...
    def train(self, input, output):
        ...
        self.output = self.query(input)
        self.input = numpy.array([[elem] for  elem in input], ndmin=2)
        ...
        self.who = numpy.subtract(self.who, del_who.T)
        self.wih = numpy.subtract(self.wih, del_wih.T)
